...
> Gemini 助手：支持对话大纲、提示词管理、模型锁定、主题一键切换、标签页增强、Markdown 加粗修复、阅读历史恢复、双向锚点、自动加宽页面、中文输入修复，智能适配 Gemini 标准版/企业版

**主要功能**：

-   ✅ 会话管理（📁 文件夹归档 / 🏷️ 多色标签 / 🔍 实时搜索 / 📌 批量操作）
-   ✅ 对话大纲（智能提取用户提问与 H1-H6 标题，支持跳转/折叠/层级过滤）
-   ✅ 提示词管理（快速插入、分类、搜索、拖动排序）
-   ✅ 标签页增强（生成状态显示、自定义格式、隐私模式、完成通知）
...
-   ✅ 主题切换动画（圆形扩散效果，View Transitions API）
